 ...
 */
  ...
  app.get(`${baseUrl}/get/for/user`, auth.isAuthorize, chatController.getUsersChat);

  // params: chatRoom, skip.
  app.get(`${baseUrl}/get/for/group`, auth.isAuthorize, chatController.getGroupChat);

  
  // params: chatIdCsv.
  app.post(`${baseUrl}/mark/as/seen`, auth.isAuthorize, chatController.markChatAsSeen);
 ...
 */
  ...
  app.get(`${baseUrl}/count/unseen`, auth.isAuthorize, chatController.countUnSeenChat);
 ...
 */
  ...
  app.get(`${baseUrl}/find/unseen`, auth.isAuthorize, chatController.findUnSeenChat);
 ...
 */
  // params: userId.
  app.get(`${baseUrl}/unseen/user/list`, auth.isAuthorize, chatController.findUserListOfUnseenChat);
